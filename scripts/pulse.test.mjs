...
test('fixture run produces spec-shaped json', () => {
  ...
  assert.deepEqual(json.days['2026-08-06'], { cio: 2, commits: 2, aiCommits: 1, prs: 2, agentPrs: 1, model: 'Fable 5' });
  assert.deepEqual(json.days['2026-08-10'], { cio: 1, personal: 1, commits: 2 });
